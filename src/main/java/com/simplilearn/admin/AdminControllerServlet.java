...
public class AdminControllerServlet extends HttpServlet {
	...
	private void studentsList(HttpServletRequest request, HttpServletResponse response) throws Exception, NullPointerException {
	...
	private void teachersList(HttpServletRequest request, HttpServletResponse response) throws Exception,NullPointerException {
		// get students from db util
	...
	private void subjectList(HttpServletRequest request, HttpServletResponse response) throws Exception,NullPointerException {
	...
	private void classestList(HttpServletRequest request, HttpServletResponse response) throws Exception,NullPointerException {
		// get subjects from db util
	...
	private void login(HttpServletRequest request, HttpServletResponse response) throws Exception,NullPointerException {
	...
	private void classStudentsList(HttpServletRequest request, HttpServletResponse response) throws Exception,NullPointerException {
	...
	private boolean getCookies(HttpServletRequest request, HttpServletResponse response) throws Exception,NullPointerException {
